...
from env.recurrent_security_env import SecurityEnv
from controller.recurrent_controller import NaiveController
...
def get_make_ppo_agent(reset_every, timesteps_per_actorbatch, max_iterations, n_rounds, myopic):
    def make_ppo_agent(observation_space, action_space, type_space, handlers):
        ...
        agent = PPOAgent(name="ppo_agent_%d" % ppo_agent_cnt, policy_fn=policy,
                         ...
                         ac_space=action_space, tp_space=type_space, n_rounds=n_rounds,
                         steps_per_round=1, handlers=handlers,
